...
Class Server extends WFF_Controller {
    ...
    function loadavg()
    {
    	...
    	echo json_encode(array("data" => $loadavg, "runningfor" => $runningfor, "users" => $users));
    }
    ...
    function ram()
    {
		...
		echo json_encode(array("free" => $free_mem));
    }
    ...
    function service()
    {
    	$timeout = 1;
    	$services = array();
		//$services[] = array("port" => 80, "service" => "Web 4Xs", "ip" => "") ;
		$services[] = array("port" => 8081, "service" => "Web PBX", "ip" => "") ;
		$services[] = array("port" => 21, "service" => "FTP", "ip" => "");
		$services[] = array("port" => 22, "service" => "Open SSH", "ip" => "");
        $services[] = array("port" => 443, "service" => "Websocket", "ip" => "");
		...
		//$services[] = array("port" => 27017, "service" => "Mongo", "ip" => "");
