<div id="detail" data-role="splitter"
    ...
    <div class="col-sm-3" style="height: 80vh; overflow-y: auto; padding: 0">
        ...
        <div data-role="tabstrip">
            ...
            <div>
                <div data-template="logs-template" data-bind="source: ticketLogsInfo"></div>
                <a style="float: right" href="#" data-bind="click: show_more">@Show more@</a>
            </div>
...
var Detail = function() {
    var observable = Object.assign(Config.observable, {
        ...
        ticketLogsInfo: new kendo.data.DataSource({
            transport: {
                read: {
                    ...
                    response.data.map(function(doc, idx){
                        ...
                        if(typeof doc.update_field !== 'undefined') {
                            doc.update_field.map(function(field, index) {
                                doc.action.push({field: field, old_data: doc.old_data[field], new_data: doc.new_data[field]});
                            });
                        }
                    });
                    return response;
        ...
        show_more: function() {
            window.Config.logs_view = Config.logs_view + 5;
            Detail.model.ticketLogsInfo.read();
        },
        reAssign: function() {
