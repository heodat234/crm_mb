...
<script id="queue-template" type="text/x-kendo-template"> 
    <li>
        ...
        <button class="btn btn-xs btn-default text-center pull-right" style="margin-top: -2px; padding: 1px 1px 1px 5px; line-height: 1.2" data-bind="click: changeQueue, attr: {title: queuename, data-status: queuememberpaused}">
