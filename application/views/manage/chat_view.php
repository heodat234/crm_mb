			...
			<div class="block">
			    ...
			    <div class="chatui-container block-content-full">
			            ...
			            <div class="chatui-people-scroll">
			                ...
			                <div class="list-group">
			                    <a href="javascript:void(0)" class="list-group-item active">
			                        ...
			                        <img src="public/proui/img/placeholders/avatars/avatar.jpg" alt="Avatar" class="img-circle">
			                    ...
			                    <a href="javascript:void(0)" class="list-group-item">
			                        <img src="public/proui/img/placeholders/avatars/avatar5.jpg" alt="Avatar" class="img-circle">
			                ...
			                <div class="list-group">
			                    ...
			                    <a href="javascript:void(0)" class="list-group-item">
			                        <img src="public/proui/img/placeholders/avatars/avatar6.jpg" alt="Avatar" class="img-circle">
			                ...
			                <div class="list-group">
			                    ...
			                    <a href="javascript:void(0)" class="list-group-item">
			                        ...
			                        <img src="public/proui/img/placeholders/avatars/avatar2.jpg" alt="Avatar" class="img-circle">
			            ...
			            <div class="chatui-talk-scroll">
			                <ul>
			                    ...
			                    <li class="chatui-talk-msg chatui-talk-msg-highlight themed-border">
			                        <img src="public/proui/img/placeholders/avatars/avatar.jpg" alt="Avatar" class="img-circle chatui-talk-msg-avatar"> Hey admin?
			                    </li>
			                    <li class="chatui-talk-msg chatui-talk-msg-highlight themed-border">
			                        <img src="public/proui/img/placeholders/avatars/avatar.jpg" alt="Avatar" class="img-circle chatui-talk-msg-avatar"> How are you?
			                    </li>
			                    <li class="text-center"><small>just now</small></li>
			                    <li class="chatui-talk-msg">
			                        <img src="public/proui/img/placeholders/avatars/avatar.jpg" alt="Avatar" class="img-circle chatui-talk-msg-avatar"> I'm fine, thanks!
			                    </li>
			                </ul>
			            </div>
			        </div>
			        ...
			        <div class="chatui-input">
			            <form action="page_ready_chat.html" method="post" class="form-horizontal form-control-borderless remove-margin">
